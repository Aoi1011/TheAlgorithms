...
/// Reference counting means keeping track of the number of references to a value in order to know
/// if a value is still in use or not.
    ...
    pub fn push_front(&mut self, data: T) {
        match self.first.take() {
            Some(r) => {
                ...
                // tell the first object is now in front of it
    ...
    pub fn push_back(&mut self, data: T) {
        match self.last.take() {
            Some(r) => {
                ...
                // tell the last object this is now in front of it
